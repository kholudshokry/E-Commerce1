...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        id: 80,
        title: "The Design of Future Things Paperback",
        price:" $ 22.00",
        imageUrl: "imges/book img/artsauth3-1.PNG",
        qty:1,
    },
   { id: 81,
    title: "The Psychology Of Everyday Things Hardcover",
    price:"$ 46.00",
    imageUrl: "imges/book img/artsauth3-2.PNG",
    qty:1,

},
{  id: 82,
    title: "Defending Human Attributes in the Age of the Machine",
    price:"$36.00",
    imageUrl: "imges/book img/artsauth3-3.PNG",
    qty:1
...
},
{
     ...
     price:"$17.00",
     imageUrl: "imges/book img/artsauth3-4.PNG",
     qty:1
},
