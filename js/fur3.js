...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        id: 80,
        title: "Sanders End Table with Storage",
        price:" $ 22.00",
        imageUrl: "imges/Home&kitchen/live3.jpg",
        qty:1,
    },
   { id: 81,
    title: "Sanders Upholstered Standard Bed",
    price:"$ 46.00",
    imageUrl: "imges/Home&kitchen/bed4.jpg",
    qty:1,

},
{  id: 82,
    title: "Sanders 2 Drawer Accent Chest",
    price:"$36.00",
    imageUrl: "imges/Home&kitchen/cap3.jpg",

},
{
     id: 83,
     title: "Sanders Configurable Office Set",
     price:"$17.00",
     imageUrl: "imges/Home&kitchen/off4.jpg",
     qty:1
},
...
function drawProductsUI(){
    let productsUI = products.map((item)=>{
        ...
        <div class="card-footer">
          <a href="furniture-product-page.html" class="card-link">See More ...</a>
        </div>
      </div>
        `;
