let productsDom = document.querySelector(".products")
 ...
 let badgeDom = document.querySelector(".badge");
     ...
     let products = [{
         ...
         title: "Beesline Foam",
         price:" $ 36.00",
         imageUrl: "imges/Skin Care img/best1.jpg",
         qty:1,
     },
    { id: 41,
     title: "Balea Ampoules",
     price:"$ 40.00",
     imageUrl: "imges/Skin Care img/best2.jpg",
     qty:1,
 
 },
 {  id: 42,
     title: "Effaclar Foaming Gel",
     price:"$30.00",
     imageUrl: "imges/Skin Care img/best3.png",
     qty:1
 
 },
 {
      id: 43,
      title: "Moisturizing + HA",
      price:"$20.00",
      imageUrl: "imges/Skin Care img/best4.PNG",
      qty:1
 },
