 ...
 let badgeDom = document.querySelector(".badge");
     ...
     let products = [{
         ...
         title: "Product Name",
         price:" $ 22.00",
         imageUrl: "imges/laptops/cursour1.jpg",
         qty:1,
     },
    { id: 6,
     title: "Product Name",
     price:"$ 46.00",
     imageUrl: "imges/laptops/cursour2.jpg",
     qty:1,
 ...
 {  id:7 ,
     title: "Product Name",
     price:"$36.00",
     imageUrl: "imges/laptops/courser3.jpg",
     qty:1
 ...
 let products1 = [{
    ...
    title: "Product Name",
    price:" $ 22.00",
    imageUrl: "imges/laptops/dell.jpg",
    qty:1,
},
{ id: 11,
title: "Product Name",
...
},
{
 ...
 function drawProductsUI1(){
    let productsUI = products1.map((item)=>{
        return ` 
        <div class="card">
            ...
            <ul class="action-button ">
                ...
                <li>
                    <a href="# " title="add to cart " tabindex="0 ">
                        <i class="zmdi zmdi-shopping-cart-plus " onclick="addedToCart1(${item.id})"></i>
                    </a>
                </li>
        ...
        <div class="card-footer ">
            <a href="lab-product-page.html" class="card-link ">See More ...</a>
        </div>
        </div>
   `;
...
drawProductsUI1();
 ...
 function drawProductsUI(){
     let productsUI = products.map((item)=>{
         return ` 
         <div class="lab">
         <img class="acer" src="${item.imageUrl}"></img>
         <div class="lab-descreption">
             <h5 style="text-align: center;">${item.title}</h5>
             <i style=" color: #ff7f00;" class="zmdi zmdi-star"></i>
             <i style=" color: #ff7f00;" class="zmdi zmdi-star"></i>
             <i style=" color: #ff7f00;" class="zmdi zmdi-star"></i>
             <i style=" color: #ff7f00;" class="zmdi zmdi-star"></i>
         </div>
         <p style="text-align: center;margin: auto; font-size: 23px;">$ 689.00</p>
         <div class="add-to-cart">
             <a href="lab-product-page.html" onclick="addedToCart(${item.id})">Add to Cart</a>
         </div>
     </div>
    `;
 ...
 function addedToCart(id){
  ...
  function getuniqueArr(arr,filterType){
   ...
   function addToFavourite(id){
       ...
       function addedToCart1(id){
        if (localStorage.getItem("users")){
    
            let choosenItem = products1.find((item) => item.id=== id );
            let item = allItems.find((i) => i.id === choosenItem.id);
            if (item){
                choosenItem.qty += 1;
            }else{
