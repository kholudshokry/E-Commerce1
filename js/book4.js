...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        ...
        price:" $ 22.00",
        imageUrl: "imges/book img/auth3book1.PNG",
        qty:1,
    },
   { id: 81,
    title: "Meluha Ke Mritunjay (Immortals of Meluha)",
    price:"$ 46.00",
    imageUrl: "imges/book img/auth3book2.PNG",
    qty:1,

},
{  id: 82,
    title: "Ikshvaku Ke Vanshaj (Hindi) Paperback",
    price:"$36.00",
    imageUrl: "imges/book img/auth3book3.PNG",
    qty:1

},
{
     id: 83,
     title: "Vayuputron Ki Shapath (The Oath of the Vayuputras) ",
     price:"$17.00",
     imageUrl: "imges/book img/auth3book4.PNG",
     qty:1
},
