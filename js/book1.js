...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        id: 1,
        title: "Roses Are Blood Red Paperback",
        price:" $ 22.00",
        imageUrl: "imges/book img/auth4book1.PNG",
        qty:1,
    },
   { id: 2,
    title: "Half Torn Hearts (City Plans) Paperback",
    price:"$ 46.00",
    imageUrl: "imges/book img/auth4book2.PNG",
    qty:1,

},
{  id: 3,
    title: "The Best Couple Ever Paperback",
    price:"$36.00",
    imageUrl: "imges/book img/auth4book3.PNG",
    qty:1

},
{
     id: 4,
     title: "Thrillers to Remember Paperback",
     price:"$17.00",
     imageUrl: "imges/book img/auth4book4.PNG",
     qty:1
},
