let productsDom = document.querySelector(".products")
 ...
 let badgeDom = document.querySelector(".badge");
     ...
     let products = [{
         id: 25,
         title: "Elvive Dream Lengths",
         price:" $ 22.00",
         imageUrl: "imges/Hair Care img/elvpr1.PNG",
         qty:1,
     },
    { id: 26,
     title: "Elvive Total Repair",
     price:"$ 46.00",
     imageUrl: "imges/Hair Care img/elvpr2.PNG",
     qty:1,
 
 },
 {  id: 27,
     title: "Elvive Shampoo",
     price:"$36.00",
     imageUrl: "imges/Hair Care img/elvpr3.PNG",
     qty:1
 
 },
 {
      id: 28,
      title: "Elvive Erasing Balm",
      price:"$17.00",
      imageUrl: "imges/Hair Care img/elvpr4.PNG",
      qty:1
 },
