...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        ...
        price:" $ 22.00",
        imageUrl: "imges/book img/auth1book1.PNG",
        qty:1,
    },
   { id: 81,
    title: "Harry Potter and the Goblet of Fire Kindle Edition",
    price:"$ 46.00",
    imageUrl: "imges/book img/auth1book2.PNG",
    qty:1,

},
{  id: 82,
    title: "Harry Potter and the Half-Blood Prince Kindle Edition",
    price:"$36.00",
    imageUrl: "imges/book img/auth1book3.PNG",
    qty:1

},
{
     id: 83,
     title: "Harry Potter and the Prisoner of Azkaban Kindle Edition ",
     price:"$17.00",
     imageUrl: "imges/book img/auth1book4.PNG",
     qty:1
},
