...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        id: 111,
        title: "Detoxifying Body Mask",
        price:" $ 222.00",
        imageUrl: "imges/Body Care img/olaypr1.PNG",
        qty:1,
    },
   { id: 112,
    title: "Pitaya & Cranberry Seed",
    price:"$ 146.00",
    imageUrl: "imges/Body Care img/olaypr2.PNG",
    qty:1,
...
{  id: 113,
    title: "Body Wash",
    price:"$361.00",
    imageUrl: "imges/Body Care img/olaypr3.PNG",
    qty:1,

},
{
     id: 114,
     title: "Body Wash Shea",
     price:"$178.00",
     imageUrl: "imges/Body Care img/olaypr4.PNG",
     qty:1,
},
