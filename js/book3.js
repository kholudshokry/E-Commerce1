...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        id: 80,
        title: "A Study in Scarlet Kindle Edition",
        price:" $ 22.00",
        imageUrl: "imges/book img/auth2book1.PNG",
        qty:1,
    },
   { id: 81,
    title: "History Books & Memoirs Kindle Edition",
    price:"$ 46.00",
    imageUrl: "imges/book img/auth2book2.PNG",
    qty:1,

},
{  id: 82,
    title: "The Adventures of Sherlock Holmes Kindle Edition",
    price:"$36.00",
    imageUrl: "imges/book img/auth2book3.PNG",
    qty:1

},
{
     id: 83,
     title: "The Secret Agent: Ultimate Spy Collection Kindle Edition ",
     price:"$17.00",
     imageUrl: "imges/book img/auth2book4.PNG",
     qty:1
},
