...
let badgeDom = document.querySelector(".badge");
    ...
    let products = [{
        ...
        price:" $ 22.00",
        imageUrl: "imges/book img/Artsbest1.PNG",
        qty:1,
    },
   { id: 81,
    title: "Refreshing Mandala - Colouring Book for Adults Book 1 Paperback",
    price:"$ 46.00",
    imageUrl: "imges/book img/artsbest2.PNG",
    qty:1,

},
{  id: 82,
    title: "The Design of Everyday Things: Revised and Expanded Edition Paperback",
    price:"$36.00",
    imageUrl: "imges/book img/artsbest3.PNG",
    qty:1

},
{
     id: 83,
     title: "Nature, Garden and Forest: Colouring Books for Adults with Tear Out Sheets",
     price:"$17.00",
     imageUrl: "imges/book img/artsbest4.PNG",
     qty:1
},
